...
class MOFTCScoresSkill(MycroftSkill):

    # The constructor of the skill, which calls MycroftSkill's constructor
    def __init__(self):
        super(MOFTCScoresSkill, self).__init__(name="MOFTCScoresSkill")
